from .conversions import univariate_to_matrix, matrix_to_univariate, univariate_to_sequence, sequence_to_univariate, univariate_to_truth_table, truth_table_to_univariate
...
__convert__ = ['univariate_to_matrix', 'matrix_to_univariate', 'univariate_to_sequence', 'sequence_to_univariate', 'univariate_to_truth_table', 'truth_table_to_univariate']
